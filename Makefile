...
known_hosts:
	grep --quiet '^stats.bi.privat' ~/.ssh/known_hosts || echo "stats.bi.privat ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJLhLsIO61hj8Kk6VQWTq5JU+PRm5/so1k44yZQTwvVO" >> ~/.ssh/known_hosts
	...
	grep --quiet '^cvmfs1-ufr0.bi.privat' ~/.ssh/known_hosts || echo "cvmfs1-ufr0.bi.privat ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJLhLsIO61hj8Kk6VQWTq5JU+PRm5/so1k44yZQTwvVO" >> ~/.ssh/known_hosts
